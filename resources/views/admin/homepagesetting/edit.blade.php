        ...
        <form action="{{route('homepageSetting.update',$cat_section->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div id="category_partner" class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-6 remove">
                ...
                <div class="col-md-7">
                    ...
                    @endcan
                    <!-- /.card -->
                    <div class="card card-secondary" id="{{$cat_section->layout=='layout3' || $cat_section->layout=='layout5' ? 'partners' : ''}}">
                        <div class="card-header">
...
<script type="text/javascript">
    $(document).ready(function (e) {
      ...
      $('.demo-select2').select2({
        ...
        $(".demo-select2").on("select2:select", function (evt) {
        ...
        $("input:checkbox").on("click", function () {
            ...
            if ($box.is(":checked")) {
                ...
                $box.prop("checked", true);
              	if (id == "layout1" || id == "layout2" || id == "layout4") {
